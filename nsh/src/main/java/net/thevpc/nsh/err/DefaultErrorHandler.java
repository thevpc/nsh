 ...
 * @author thevpc
 */
public class DefaultErrorHandler implements NshErrorHandler {

    @Override
    public boolean isQuitException(Throwable th) {
        return th instanceof NshQuitException;
    }
    ...
    @Override
    public void onError(String message, Throwable th, NshContext context) {
