...
public abstract class NshBuiltinBase implements NshBuiltin {
    ...
    protected abstract boolean nextOption(NArg arg, NCmdLine cmdLine, NshExecutionContext context);
    protected abstract boolean nextNonOption(NArg arg, NCmdLine cmdLine, NshExecutionContext context);

    protected abstract void main(NCmdLine cmdLine, NshExecutionContext context);

    protected void validate(NCmdLine cmdLine, NshExecutionContext context) {
    ...
    public void autoComplete(NshExecutionContext context, NCmdLineAutoComplete autoComplete) {
        ...
        try {
            ...
            NCommandAutoCompleteComponent best = NWorkspace.get().get().extensions().createServiceLoader(NCommandAutoCompleteComponent.class, NshBuiltin.class, NCommandAutoCompleteComponent.class.getClassLoader())
