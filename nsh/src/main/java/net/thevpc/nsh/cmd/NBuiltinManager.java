 ...
 * @author thevpc
 */
public class NBuiltinManager implements NshBuiltinManager {
    ...
    @Override
    public void set(NshBuiltin command) {
    ...
    public boolean unset(String command) {
        ...
        if (LOG.isLoggable(Level.FINE)) {
            if (b) {
                LOG.log(Level.FINE, "Uninstalling NshCommandNode : " + command);
            }
        }
        return b;
    }
