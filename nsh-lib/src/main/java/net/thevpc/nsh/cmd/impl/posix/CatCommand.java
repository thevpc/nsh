...
public class CatCommand extends NshBuiltinDefault {
    ...
    private void catText2(InputStream in, Options options, NshExecutionContext context, FileInfo info, List<CatResult> results) throws IOException {
        boolean whole = true;
        NSession session = context.getSession();
    ...
    private void catText(InputStream in, OutputStream os, Options options, NshExecutionContext context, FileInfo info) throws IOException {
