...
import net.thevpc.nsh.cmd.impl.util.BufferedLineIterator;
import net.thevpc.nsh.cmd.impl.util.NNumberedObject;
import net.thevpc.nsh.cmd.impl.util.WindowFilterIterator;
import net.thevpc.nsh.cmd.impl.util.WindowObject;
        ...
        Predicate<NPath> fileName = new Predicate<NPath>() {
            ...
            public boolean test(NPath nPath) {
                ...
                for (Pattern pattern : patterns) {
                    if (pattern.matcher(nPath.name()).matches()) {
                        return true;
                    }
                }
                return false;
