 ...
 * ====================================================================
 */
package net.thevpc.nsh.cmd.impl.posix.extra;
...
public class HostsCommand extends NshBuiltinDefault {
    ...
    private boolean nextOptionAdd(NCmdLine cmdLine, NshExecutionContext context, Options config) {
        NSession session = context.getSession();
    ...
    private boolean nextOptionRemove(NCmdLine cmdLine, NshExecutionContext context, Options config) {
        NSession session = context.getSession();
