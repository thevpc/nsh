...
// */
//public class BytesSizeFormatN implements net.thevpc.nuts.text.NDoubleFormat {
//
//
//    public static final BytesSizeFormatN INSTANCE = new BytesSizeFormatN();
...
//
//    public BytesSizeFormatN(boolean leadingZeros, boolean intermediateZeros, boolean fixedLength, boolean binaryPrefix, char high, char low, int depth) {
...
//     */
//    public BytesSizeFormatN(String format) {
//        leadingZeros = false;
